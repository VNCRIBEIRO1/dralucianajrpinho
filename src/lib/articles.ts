// Artigos do Blog — Dra. Luciana J. R. Pinho
...
O Benefício de Prestação Continuada (BPC), previsto na Lei Orgânica da Assistência Social (LOAS), é um benefício assistencial no valor de um salário mínimo, garantido a pessoas com deficiência e idosos com 65 anos ou mais que comprovem não possuir meios de garantir seu próprio sustento.

## Quem tem direito?

- **Pessoas com deficiência** de qualquer idade, que comprovem impedimentos de longo prazo (físico, mental, intelectual ou sensorial)
- **Idosos** com 65 anos ou mais
- Renda per capita familiar inferior a 1/4 do salário mínimo (critério que pode ser flexibilizado judicialmente)

## Como solicitar?

1. Inscrição no CadÚnico
2. Agendamento no INSS (telefone 135 ou site Meu INSS)
3. Apresentação de documentação pessoal e médica
4. Avaliação social e perícia médica

## O que fazer em caso de negativa?

Se o INSS negar o benefício, você tem direito a:
- Recurso administrativo ao CRPS
- Ação judicial com pedido de tutela antecipada
- Revisão de benefício já concedido

**Importante:** A análise judicial considera aspectos mais amplos que a administrativa, incluindo condições sociais e pessoais do requerente.
...
A Lei 12.764/2012 (Lei Berenice Piana) reconhece o autismo como deficiência para todos os efeitos legais, garantindo uma série de direitos fundamentais.
...
- Terapias como ABA, fonoaudiologia e terapia ocupacional

### Educação
- Direito a acompanhante especializado em sala de aula
- Adaptações curriculares
- Matrícula garantida em escola regular

### Assistência Social
- BPC/LOAS para famílias de baixa renda
- Prioridade no CadÚnico
- Acesso a programas sociais

### Trabalho
- Cotas em empresas (Lei 8.213/91)
...
O planejamento previdenciário é uma análise técnica e detalhada do histórico contributivo do segurado, com o objetivo de identificar a melhor estratégia para obter o benefício mais vantajoso possível.

## Por que é importante?

Após a Reforma da Previdência (EC 103/2019), as regras de aposentadoria ficaram mais complexas. Um planejamento inadequado pode resultar em:
- Aposentadoria com valor menor que o devido
- Perda de tempo e contribuições valiosas
- Desconhecimento de regras de transição mais vantajosas

## O que envolve?

1. **Análise do CNIS** — verificação de todos os vínculos e contribuições
2. **Identificação de períodos faltantes** — reconhecimento de tempo rural, especial, militar
3. **Simulação de cenários** — cálculo em todas as regras disponíveis
4. **Estratégia personalizada** — orientação sobre a melhor data e regra para aposentadoria

## Quando procurar um especialista?

O ideal é iniciar o planejamento previdenciário pelo menos 5 anos antes da data prevista para aposentadoria, mas nunca é tarde para uma análise técnica.
...
*Este conteúdo tem caráter informativo e não substitui consulta jurídica individualizada.*
  ...
  {
    slug: 'capacitismo-o-que-e',
    title: 'Capacitismo: O Que É e Como Combatê-lo',
    excerpt:
      'Entenda o que é capacitismo, como ele se manifesta no dia a dia e quais são os caminhos legais para combatê-lo.',
    content: `
## O que é Capacitismo?

Capacitismo é a discriminação e o preconceito contra pessoas com deficiência. Assim como o racismo e o machismo, o capacitismo é uma forma de opressão estrutural que limita o acesso dessas pessoas a direitos fundamentais.

## Como se manifesta?

- Barreiras arquitetônicas e falta de acessibilidade
- Linguagem infantilizadora ou condescendente
- Exclusão do mercado de trabalho
- Negação de direitos educacionais
- Subestimação de capacidades

## O que a lei diz?

A Lei Brasileira de Inclusão (Lei 13.146/2015) é o principal instrumento legal de combate ao capacitismo no Brasil. Ela garante:
- Acessibilidade universal
- Inclusão escolar e laboral
- Autonomia e capacidade civil plena
- Proteção contra discriminação
...
4. Ação judicial por danos morais e materiais
