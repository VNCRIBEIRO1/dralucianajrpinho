...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-to-br from-[#07040f] via-[#150c2a] to-[#2d1b4e] overflow-hidden">
      {/* Themed inclusion background — watercolor puzzle pieces */}
      <div className="absolute inset-0 opacity-[0.12]">
        <Image
          src={IMAGES.heroInclusionBg}
          alt=""
          fill
      ...
      {/* Rainbow bar topo — 6 cores do espectro */}
      <div className="absolute top-0 left-0 right-0 h-1 rainbow-bar z-20" />

      {/* Decorative blurs — autism awareness colors */}
      <div className="absolute top-20 right-10 w-72 h-72 bg-autism-blue/15 rounded-full blur-3xl animate-pulse-soft" />
      <div className="absolute bottom-32 left-10 w-96 h-96 bg-autism-red/8 rounded-full blur-3xl" />
      <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-autism-gold/10 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-20 right-1/4 w-64 h-64 bg-autism-green/8 rounded-full blur-3xl" />
      <div className="absolute top-1/3 right-1/3 w-40 h-40 bg-autism-purple/10 rounded-full blur-3xl animate-pulse-soft" />
      ...
      <div className="container-custom relative z-10 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            {/* Badge inclusão */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-autism-blue/20 via-lavender-500/20 to-autism-purple/20 text-lavender-300 px-5 py-2.5 rounded-full text-sm font-medium mb-6 border border-lavender-500/20">
              <span className="text-lg infinity-gradient font-bold">∞</span>
              Pioneira em Advocacia Social — Desde 2003
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white leading-tight mb-6">
              Seus <span className="infinity-gradient">Direitos</span> em{' '}
            ...
            <p className="text-sm text-lavender-300/90 mb-8 max-w-lg flex items-center gap-2">
              <Puzzle className="w-4 h-4 text-autism-gold" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-7 py-3.5 border-2 border-autism-green/40 text-primary-100 rounded-xl font-semibold hover:bg-autism-green/10 hover:border-autism-green/60 transition-all duration-300"
              >
            ...
            {/* Badges de credenciais — estilo com cores do espectro */}
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 bg-autism-blue/10 backdrop-blur-sm px-4 py-2 rounded-full border border-autism-blue/20">
                <Scale className="w-4 h-4 text-autism-blue" />
                <span className="text-primary-200 text-xs font-medium">OAB/MT 7973-B</span>
              </div>
              <div className="flex items-center gap-2 bg-autism-green/10 backdrop-blur-sm px-4 py-2 rounded-full border border-autism-green/20">
                <Globe className="w-4 h-4 text-autism-green" />
                <span className="text-primary-200 text-xs font-medium">OAP Portugal</span>
              </div>
              <div className="flex items-center gap-2 bg-autism-gold/10 backdrop-blur-sm px-4 py-2 rounded-full border border-autism-gold/20">
                <Star className="w-4 h-4 text-autism-gold fill-autism-gold" />
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-autism-blue/15 via-autism-purple/10 to-autism-gold/10 rounded-3xl blur-3xl scale-90" />

            {/* Container da foto */}
            <div className="relative w-[320px] md:w-[380px] lg:w-[420px]">
              {/* Foto principal */}
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/40 border-2 border-transparent" style={{ borderImage: 'linear-gradient(135deg, #e74c3c, #f1c40f, #2ecc71, #3498db, #9b59b6) 1' }}>
      ...
      {/* Wave bottom — cream color para match o body */}
